...
const MultipleSelector = React.forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex items-center h-8 rounded-md border border-input text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
          {
