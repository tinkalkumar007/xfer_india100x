...
const TimelineItem = React.forwardRef(({ className, ...props }, ref) => (
  <li
    ref={ref}
    className={cn('relative flex flex-col p-6 pt-0 [&>*]:mb-1', className)}
    {...props}
  />
))
...
const TimelineTime = React.forwardRef(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      'absolute translate-x-36  text-sm font-semibold leading-none text-secondary-foreground',
      className
    )}
    {...props}
  />
...
const TimelineDescription = React.forwardRef(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-sm ml-1 text-muted-foreground max-w-sm', className)}
    {...props}
  />
))
